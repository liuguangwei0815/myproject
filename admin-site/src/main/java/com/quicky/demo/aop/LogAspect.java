...
public class LogAspect {
	 ...
	 */
	@Pointcut("@annotation(com.quicky.demo.aop.OperationLogDetail)")
	public void operationLog() {}
	
	/**
	 * around 类似 MethodInterCepter
	 * @param ponit
	 * @return
	 * @throws Throwable 
	 */
	...
	public Object doAround(ProceedingJoinPoint joinPoint) throws Throwable {
	 ...
	 private void addOperationLog(JoinPoint joinPoint, Object res, long time){
	        ...
	        if(annotation != null){
	            ...
	            operationLog.setDescribe(getDetail(((MethodSignature)joinPoint.getSignature()).getParameterNames(),joinPoint.getArgs(),annotation));//这里处理占位符
