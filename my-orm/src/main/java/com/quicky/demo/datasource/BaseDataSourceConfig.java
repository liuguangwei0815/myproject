...
@MapperScan(
		// 此处的mapper 可以有多个
		basePackages = { BaseDataSourceConfig.MAPPER_PACKAGE }, sqlSessionFactoryRef = "baseSqlSessionTemplate")
public class BaseDataSourceConfig {

	// mapper 的xml存放路径
	protected final static String MAPPER_XML_AREA = "classpath:base/mapper/*.xml";
	// mapper.java 存放路径，被@MapperScan扫描的，注入 sqlsession的
	protected final static String MAPPER_PACKAGE = "com.quicky.demo.mapper";
